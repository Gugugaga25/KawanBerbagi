...
import { MoreVertical, Filter, Plus, Building2, CheckCircle, Clock } from 'lucide-react';
...
export default function PantiManagement() {
  return (
                ...
                <tr key={panti.id} className="hover:bg-gray-50/80 transition-colors">
                  ...
                  <td className="px-6 py-4">
                    <span className={`inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-bold ${
                      ...
                      {panti.status === 'Terverifikasi' ? <CheckCircle size={12} /> : <Clock size={12} />}
                      {panti.status}
                    </span>
                  </td>
